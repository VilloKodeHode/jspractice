...
export default function PokeData() {
  ...
  return (
    <div className="grid grid-cols-2">
      <div className="grid xl:grid-cols-3 gap-4 p-4 border">
        <h2 className="col-span-3 text-3xl">List of all pokemon:</h2>
        {pokeList?.map((pokemon) => (
          <div className="grid justify-center border p-1 shadow-md">
            <button
              key={pokemon.name}
      ...
      <div className=" flex flex-col  justify-start items-center gap-12">
        ...
        {pokemon && (
          <div className="sticky top-1/3 border-8 rounded-sm border-yellow-200">
            <ul className="grid bg-red-500 w-fit gap-4 p-8 rounded-sm">
              <li
                key={pokemon.name}
